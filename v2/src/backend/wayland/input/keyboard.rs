...
use crate::backend::{
    ...
    wayland::{window::WindowId, WaylandPlatform},
};
...
impl Dispatch<wl_keyboard::WlKeyboard, KeyboardUserData> for WaylandPlatform {
    fn event(
        state: &mut Self,
...
fn handle_repeat(
    ...
    scancode: u32,
    loop_handle: &mut LoopHandle<'_, WaylandPlatform>,
    delay: u32,
    data: &KeyboardUserData,
) {
    match &key_state {
