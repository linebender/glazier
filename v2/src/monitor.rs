...
/// The unique identifier of a monitor
///
/// This is passed to the methods of your [PlatformHandler], allowing
/// them to identify which monitor they refer to (such as when a
/// monitor's properties are changed).
///
...
impl MonitorId {
    pub(crate) fn next() -> Self {
        static MONITOR_ID_COUNTER: Counter = Counter::new();
        Self(MONITOR_ID_COUNTER.next_nonzero())
    }
